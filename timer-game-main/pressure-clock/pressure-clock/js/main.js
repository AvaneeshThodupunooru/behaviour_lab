/**
 * main.js — glues the app modules into the actual app flow:
 *   start -> calibration -> word search -> reveal -> results (+ JSON export)
 *
...
(function () {
  ...
  function runRound(cfg, onDone) {
    ...
    el.instruction.textContent = 'Find the hidden words. Drag in a straight line in any direction.';
